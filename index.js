...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vectors__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__directions__ = __webpack_require__(30);
...
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_2__vectors__; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_3__directions__["a"]; });
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_1__config__; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__redux__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__redux_actions__ = __webpack_require__(27);
...
let unsubscribe = __WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].subscribe(() =>
  console.log(__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].getState())
)

// 发起一系列 action
__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].dispatch(__WEBPACK_IMPORTED_MODULE_1__redux_actions__["a" /* move */](37));
__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].dispatch(__WEBPACK_IMPORTED_MODULE_1__redux_actions__["a" /* move */](40));
__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].dispatch(__WEBPACK_IMPORTED_MODULE_1__redux_actions__["a" /* move */](39));
__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */].dispatch(__WEBPACK_IMPORTED_MODULE_1__redux_actions__["b" /* initOrReset */]());

// 停止监听 state 更新
unsubscribe();

/* unused harmony default export */ var _unused_webpack_default_export = (__WEBPACK_IMPORTED_MODULE_0__redux__["a" /* default */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_test__ = __webpack_require__(10);
...
const move = (keyboardCode) => {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* actions */].MOVE,
    direction: __WEBPACK_IMPORTED_MODULE_0__constants__["b" /* directions */][keyboardCode]
  };
};
...
const initOrReset = () => {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* actions */].INITORRESET
  };
};
/* harmony export (immutable) */ __webpack_exports__["b"] = initOrReset;
 ...
 * 
 */
const INITORRESET   = 'INITORRESET';
/* harmony export (immutable) */ __webpack_exports__["INITORRESET"] = INITORRESET;
...
/* harmony default export */ __webpack_exports__["a"] = (directions);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducers_game__ = __webpack_require__(35);



let store = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* createStore */])(__WEBPACK_IMPORTED_MODULE_1__reducers_game__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tile__ = __webpack_require__(9);


class Cell {
  constructor(tile) {
    this.tile = tile instanceof __WEBPACK_IMPORTED_MODULE_0__tile__["a" /* default */] ? tile : null;
  }
  getTile() {
    return this.tile;
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cell__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tile__ = __webpack_require__(9);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__cell__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elements__ = __webpack_require__(34);
...
class GameState {
  constructor(width, height, target) {
    ...
    for (let i = 0; i < width; i++) {
      let cellsCloumn = [];
      for (let j = 0; j < height; j++) cellsCloumn.push(new __WEBPACK_IMPORTED_MODULE_0__elements__["a" /* Cell */]());
...
function game(state = getInitState(), action) {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* actions */].MOVE:
      return move(state, __WEBPACK_IMPORTED_MODULE_2__constants__["c" /* vectors */][action.direction]);
    case __WEBPACK_IMPORTED_MODULE_2__constants__["a" /* actions */].INITORRESET:
      return getInitState(); 
  }
}
...
function getInitState() {
  let state = new GameState(__WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length, __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width, __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].target);
...
function createTile(state) {
  let x = Math.floor(Math.random() * __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width);
  let y = Math.floor(Math.random() * __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length);

  while (!state.cells[x][y].isEmpty()) {
    x = Math.floor(Math.random() * __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width);
    y = Math.floor(Math.random() * __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length);
  }

  let value = Math.random() * 100 > 70 ? 4 : 2;

  let newTile = new __WEBPACK_IMPORTED_MODULE_0__elements__["b" /* Tile */](x, y, value);
...
function findTheOpen(list) {
  ...
  for (let i = 0; i < __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width * __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length; i++) {
    if (!list[i]) {
      index = i;
      break;
    }
...
function move(state, direction) {
  ...
  let i = isConverse ? __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width - 1 : 0;
  let j = isConverse ? __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length - 1 : 0;

  while (isConverse ? i >= 0 : i < __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width) {
    while (isConverse ? j >= 0 : j < __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length) {
...
function overStep(tile, direction) {
  ...
  return x < 0 || y < 0 || x >= __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].width || y >= __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* config */].length;
}
